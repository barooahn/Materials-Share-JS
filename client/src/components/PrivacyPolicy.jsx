...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>
        Materials Share ("us", "we", or "our") operates the
        https://materials-share.herokuapp.com website and the Materials Share
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for Materials Share
      ...
      <ul>
        <li>
          ...
          <p>
            Service means the https://materials-share.herokuapp.com website and
            the Materials Share mobile application operated by Materials Share
          </p>
        </li>
        <li>
          <p>
      ...
      <p>Materials Share uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Materials Share will take all steps reasonably necessary to ensure that
      ...
      <p>
        Materials Share may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Materials Share</li>
        <li>
      ...
      <ul>
        <li>By visiting this page on our website: Materials Share</li>
      </ul>
    </div>
  );
};
